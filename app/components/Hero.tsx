  ...
  return (
    <section className="relative min-h-[78vh] overflow-hidden rounded-[2rem]">
      <Image
        ...
        priority
      />
      <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(18,24,17,0.62)_0%,rgba(18,24,17,0.36)_45%,rgba(18,24,17,0.54)_100%)]" />

      <div className="relative z-10 flex h-full min-h-[78vh] flex-col justify-between px-6 py-8 md:px-12 md:py-10">
        <div className="flex items-center justify-between text-[rgba(232,241,208,0.95)]">
          <p className="text-2xl font-semibold tracking-tight">Lilly Combest</p>
        ...
        <div className="pb-8 md:pb-12">
          <h1 className="text-[clamp(2.6rem,9vw,7.5rem)] leading-[0.95] tracking-tight text-[rgb(var(--color-primary-light))]">
            eat well.
            <span className="ml-2 font-serif italic text-[rgba(247,244,234,0.95)]">feel alive.</span>
          </h1>
