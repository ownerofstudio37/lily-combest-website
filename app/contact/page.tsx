...
export default function Contact(){
  ...
  return (
    <div className="max-w-5xl mx-auto py-16 px-4">
      ...
      <form id="consultation-request" name="contact" method="POST" onSubmit={handleSubmit} className="max-w-2xl rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
