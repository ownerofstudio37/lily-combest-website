...
export default function HomePage() {
  ...
  return (
    <div className="container mx-auto px-4 py-6 space-y-10 section-cream">
      <Hero />
      <Services />
      ...
      <section className="py-14 rounded-[2rem] bg-[rgb(var(--color-primary-dark))] text-[rgb(var(--color-secondary-light))]">
